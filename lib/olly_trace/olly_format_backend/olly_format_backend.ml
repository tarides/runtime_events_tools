module type Format = sig
  ...
  val emit :
    trace -> ring_id:int -> ts:int64 -> name:string -> kind:Event.kind -> unit

  val emit_counter :
    trace -> ring_id:int -> ts:int64 -> name:string -> value:int -> unit
end
...
type trace = {
  close : unit -> unit;
  emit : ring_id:int -> ts:int64 -> name:string -> kind:Event.kind -> unit;
  emit_counter : ring_id:int -> ts:int64 -> name:string -> value:int -> unit;
}
