...
Trace subcommand help:
  ...
  OPTIONS
         ...
         --proc-stat-freq=proc-stat-freq (absent=0.1)
             ...
             buffer can be attributed to it, currently on Linux only, the peak
             is the maximum over samples of the RSS less the ring: only the
             current RSS can be decomposed that way, so a shorter interval
             ...
             they cannot, on OSX and FreeBSD and wherever the ring's mapping
...
GC stats subcommand help:
  ...
  DESCRIPTION
         ...
         Max RSS
             ...
             that is Linux only; elsewhere the figure still includes the ring,
